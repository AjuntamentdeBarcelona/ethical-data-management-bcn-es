...
:uri-public-repo: https://github.com/AjuntamentdeBarcelona/ethical-data-management-bcn-es
//
// MANDATORY. Exactly the same value you give to key "name" in file antora.yml.
:component-name: es/data-management
//
// MANDATORY. Title of the document. In web format, it appears as a heading of
// level 1. In PDF format, it appears in a title page.
:_title: Medida Gov. Gestión Ética de los Datos
//
...
//
// OPTIONAL. Semi-colon-separated list of names.
:_reviewers: Roberto di Cosmo, Ivan Mingueza
//
...
:_summary: Medida de Gobierno de Gestión Ética y Responsable de Datos: Barcelona Data Commons
//
// MANDATORY. Comma-separated list of terms to help classifying and searching
// the document. In web format, this terms are integrated as SEO enabling
// metadata. In PDF format, they are shown near the other metadata.
:keywords: ethical digital standards, digital rights, Barcelona, City Council, gestión datos, datos por el bien común, rendición de cuentas, ética de datos
//
